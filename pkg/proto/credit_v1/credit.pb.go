...
type CreateCreditApplicationResponse struct {
	...
	Status        CreditApplicationStatus `protobuf:"varint,2,opt,name=status,proto3,enum=credits.CreditApplicationStatus" json:"status,omitempty"` // Статус заявки (обычно PENDING)
...
type GetCreditApplicationResponse struct {
	...
	ApplicationId  string                  `protobuf:"bytes,1,opt,name=application_id,json=applicationId,proto3" json:"application_id,omitempty"`      // UUID заявки
	Status         CreditApplicationStatus `protobuf:"varint,2,opt,name=status,proto3,enum=credits.CreditApplicationStatus" json:"status,omitempty"`   // Текущий статус заявки
...
type UpdateCreditApplicationStatusRequest struct {
	...
	ApplicationId  string                  `protobuf:"bytes,1,opt,name=application_id,json=applicationId,proto3" json:"application_id,omitempty"`                           // UUID заявки
	NewStatus      CreditApplicationStatus `protobuf:"varint,2,opt,name=new_status,json=newStatus,proto3,enum=credits.CreditApplicationStatus" json:"new_status,omitempty"` // Новый статус заявки (APPROVED или REJECTED)
...
type UpdateCreditApplicationStatusResponse struct {
	...
	ApplicationId string                  `protobuf:"bytes,1,opt,name=application_id,json=applicationId,proto3" json:"application_id,omitempty"`    // UUID заявки
	Status        CreditApplicationStatus `protobuf:"varint,2,opt,name=status,proto3,enum=credits.CreditApplicationStatus" json:"status,omitempty"` // Обновлённый статус заявки
	Message       string                  `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`                                     // Дополнительное сообщение
}
...
type GetCreditResponse struct {
	...
	Status          CreditStatus `protobuf:"varint,7,opt,name=status,proto3,enum=credits.CreditStatus" json:"status,omitempty"`                 // Статус кредита
...
type PaymentSchedule struct {
	...
	Status    PaymentStatus `protobuf:"varint,4,opt,name=status,proto3,enum=credits.PaymentStatus" json:"status,omitempty"` // Статус платежа
}
...
type UpdatePaymentScheduleRequest struct {
	...
	PaymentId string        `protobuf:"bytes,1,opt,name=payment_id,json=paymentId,proto3" json:"payment_id,omitempty"`                             // UUID платежа
	NewStatus PaymentStatus `protobuf:"varint,2,opt,name=new_status,json=newStatus,proto3,enum=credits.PaymentStatus" json:"new_status,omitempty"` // Новый статус платежа
}
...
type UpdatePaymentScheduleResponse struct {
	...
	PaymentId string        `protobuf:"bytes,1,opt,name=payment_id,json=paymentId,proto3" json:"payment_id,omitempty"`      // UUID платежа
	Status    PaymentStatus `protobuf:"varint,2,opt,name=status,proto3,enum=credits.PaymentStatus" json:"status,omitempty"` // Обновлённый статус платежа
	Message   string        `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`                           // Дополнительное сообщение
}
...
var file_credit_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07,
	0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x1a, 0x0b, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1b, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x1e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65, 0x64,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x65, 0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x52, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x0a,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xcb, 0x01, 0x0a, 0x1f, 0x43, 0x72,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x43,
	...
	0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f,
	0x76, 0x31, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x44, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x43, 0x72,
	...
	0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xe7, 0x01,
	...
	0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e,
	...
	0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0e, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xde, 0x01, 0x0a, 0x24, 0x55, 0x70, 0x64, 0x61,
	...
	,
	...
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x63, 0x72, 0x65, 0x64,
	0x69, 0x74, 0x73, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x49, 0x64, 0x22, 0xbc,
	...
	0x6e, 0x74, 0x12, 0x2d, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x15, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x43, 0x72, 0x65,
	...
	0x16, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73,
	...
	0x65, 0x22, 0xb4, 0x01, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72,
	0x65, 0x64, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a,
	0x0b, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x43, 0x72, 0x65,
	...
	0x74, 0x61, 0x6c, 0x50, 0x61, 0x67, 0x65, 0x73, 0x22, 0xb1, 0x02, 0x0a, 0x06, 0x43, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x69, 0x64,
	...
	0x74, 0x12, 0x23, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x61,
	0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x65,
	0x73, 0x74, 0x52, 0x61, 0x74, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e,
	0x69, 0x6e, 0x67, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01,
	...
	0x0e, 0x32, 0x15, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x43, 0x72, 0x65, 0x64,
	...
	,
	...
	0x09, 0x52, 0x07, 0x64, 0x75, 0x65, 0x44, 0x61, 0x74, 0x65, 0x12, 0x2e, 0x0a, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x63, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x73, 0x2e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x74, 0x0a, 0x1c, 0x55, 0x70,
	...
	0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x0a, 0x6e, 0x65, 0x77,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e,
	0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x09, 0x6e, 0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x22, 0x88, 0x01, 0x0a, 0x1d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65,
	...
	0x0e, 0x32, 0x16, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x50, 0x61, 0x79, 0x6d,
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x56, 0x0a, 0x17, 0x43,
	0x72, 0x65, 0x64, 0x69, 0x74, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x45, 0x44, 0x10, 0x05, 0x32, 0xae, 0x06, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x56, 0x31, 0x12, 0x6c, 0x0a, 0x17, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x2e, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x43,
	...
	,
	...
	0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65,
	...
	,
	...
	,
	...
	0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61,
	...
	0x2f, 0x79, 0x6f, 0x75, 0x72, 0x72, 0x65, 0x70, 0x6f, 0x2f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74,
...
var file_credit_proto_goTypes = []any{
	(CreditApplicationStatus)(0),                  // 0: credits.CreditApplicationStatus
	(CreditStatus)(0),                             // 1: credits.CreditStatus
	(PaymentStatus)(0),                            // 2: credits.PaymentStatus
	(*CreateCreditApplicationRequest)(nil),        // 3: credits.CreateCreditApplicationRequest
	(*CreateCreditApplicationResponse)(nil),       // 4: credits.CreateCreditApplicationResponse
	(*GetCreditApplicationRequest)(nil),           // 5: credits.GetCreditApplicationRequest
	(*GetCreditApplicationResponse)(nil),          // 6: credits.GetCreditApplicationResponse
	(*UpdateCreditApplicationStatusRequest)(nil),  // 7: credits.UpdateCreditApplicationStatusRequest
	(*UpdateCreditApplicationStatusResponse)(nil), // 8: credits.UpdateCreditApplicationStatusResponse
	(*GetCreditRequest)(nil),                      // 9: credits.GetCreditRequest
	(*GetCreditResponse)(nil),                     // 10: credits.GetCreditResponse
	(*ListUserCreditsRequest)(nil),                // 11: credits.ListUserCreditsRequest
	(*ListUserCreditsResponse)(nil),               // 12: credits.ListUserCreditsResponse
	(*Credit)(nil),                                // 13: credits.Credit
	(*CreatePaymentScheduleRequest)(nil),          // 14: credits.CreatePaymentScheduleRequest
	(*CreatePaymentScheduleResponse)(nil),         // 15: credits.CreatePaymentScheduleResponse
	(*GetPaymentScheduleRequest)(nil),             // 16: credits.GetPaymentScheduleRequest
	(*GetPaymentScheduleResponse)(nil),            // 17: credits.GetPaymentScheduleResponse
	(*PaymentSchedule)(nil),                       // 18: credits.PaymentSchedule
	(*UpdatePaymentScheduleRequest)(nil),          // 19: credits.UpdatePaymentScheduleRequest
	(*UpdatePaymentScheduleResponse)(nil),         // 20: credits.UpdatePaymentScheduleResponse
	(*error_v1.ErrorResponse)(nil),                // 21: error_v1.ErrorResponse
}
var file_credit_proto_depIdxs = []int32{
	0,  // 0: credits.CreateCreditApplicationResponse.status:type_name -> credits.CreditApplicationStatus
	21, // 1: credits.CreateCreditApplicationResponse.error:type_name -> error_v1.ErrorResponse
	0,  // 2: credits.GetCreditApplicationResponse.status:type_name -> credits.CreditApplicationStatus
	0,  // 3: credits.UpdateCreditApplicationStatusRequest.new_status:type_name -> credits.CreditApplicationStatus
	0,  // 4: credits.UpdateCreditApplicationStatusResponse.status:type_name -> credits.CreditApplicationStatus
	1,  // 5: credits.GetCreditResponse.status:type_name -> credits.CreditStatus
	13, // 6: credits.ListUserCreditsResponse.credit_list:type_name -> credits.Credit
	1,  // 7: credits.Credit.status:type_name -> credits.CreditStatus
	18, // 8: credits.GetPaymentScheduleResponse.schedules:type_name -> credits.PaymentSchedule
	2,  // 9: credits.PaymentSchedule.status:type_name -> credits.PaymentStatus
	2,  // 10: credits.UpdatePaymentScheduleRequest.new_status:type_name -> credits.PaymentStatus
	2,  // 11: credits.UpdatePaymentScheduleResponse.status:type_name -> credits.PaymentStatus
	3,  // 12: credits.CreditsServiceV1.CreateCreditApplication:input_type -> credits.CreateCreditApplicationRequest
	5,  // 13: credits.CreditsServiceV1.GetCreditApplication:input_type -> credits.GetCreditApplicationRequest
	7,  // 14: credits.CreditsServiceV1.UpdateCreditApplicationStatus:input_type -> credits.UpdateCreditApplicationStatusRequest
	9,  // 15: credits.CreditsServiceV1.GetCredit:input_type -> credits.GetCreditRequest
	11, // 16: credits.CreditsServiceV1.ListUserCredits:input_type -> credits.ListUserCreditsRequest
	14, // 17: credits.CreditsServiceV1.CreatePaymentSchedule:input_type -> credits.CreatePaymentScheduleRequest
	16, // 18: credits.CreditsServiceV1.GetPaymentSchedule:input_type -> credits.GetPaymentScheduleRequest
	19, // 19: credits.CreditsServiceV1.UpdatePaymentSchedule:input_type -> credits.UpdatePaymentScheduleRequest
	4,  // 20: credits.CreditsServiceV1.CreateCreditApplication:output_type -> credits.CreateCreditApplicationResponse
	6,  // 21: credits.CreditsServiceV1.GetCreditApplication:output_type -> credits.GetCreditApplicationResponse
	8,  // 22: credits.CreditsServiceV1.UpdateCreditApplicationStatus:output_type -> credits.UpdateCreditApplicationStatusResponse
	10, // 23: credits.CreditsServiceV1.GetCredit:output_type -> credits.GetCreditResponse
	12, // 24: credits.CreditsServiceV1.ListUserCredits:output_type -> credits.ListUserCreditsResponse
	15, // 25: credits.CreditsServiceV1.CreatePaymentSchedule:output_type -> credits.CreatePaymentScheduleResponse
	17, // 26: credits.CreditsServiceV1.GetPaymentSchedule:output_type -> credits.GetPaymentScheduleResponse
	20, // 27: credits.CreditsServiceV1.UpdatePaymentSchedule:output_type -> credits.UpdatePaymentScheduleResponse
