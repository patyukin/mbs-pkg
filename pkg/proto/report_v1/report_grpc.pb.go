...
const (
	ReportService_GetUserReport_FullMethodName = "/report_v1.ReportService/GetUserReport"
)
...
func (c *reportServiceClient) GetUserReport(ctx context.Context, in *GetUserReportRequest, opts ...grpc.CallOption) (*GetUserReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserReportResponse)
	err := c.cc.Invoke(ctx, ReportService_GetUserReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReportServiceServer) GetUserReport(context.Context, *GetUserReportRequest) (*GetUserReportResponse, error) {
...
func _ReportService_GetUserReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReportServiceServer).GetUserReport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReportService_GetUserReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GetUserReport(ctx, req.(*GetUserReportRequest))
	}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "report_v1.ReportService",
	HandlerType: (*ReportServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetUserReport",
			Handler:    _ReportService_GetUserReport_Handler,
		},
	},
